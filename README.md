...
```
cd existing_repo
git remote add origin https://gitlab.esiea.fr/parsy/portfolio.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.esiea.fr/parsy/portfolio/-/settings/integrations)
